...
void Config::parseConfigFile(const std::string &filePath)
{
    ...
    while (std::getline(file, line))
    {
        ...
        if (line.empty() || line[0] == '#')
            continue; // Skips empty lines and comments
